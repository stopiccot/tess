...
void Mesh::bake() {
    ...
    glBindBuffer(GL_ARRAY_BUFFER, vertexBufferPosition);
    glVertexAttribPointer(Pointless::Shader::ATTRIB_VERTEX,    3, GL_FLOAT, GL_FALSE, sizeof(glm::vec3), 0);
    glBindBuffer(GL_ARRAY_BUFFER, vertexBufferUv);
    glVertexAttribPointer(Pointless::Shader::ATTRIB_TEXCOORD0, 2, GL_FLOAT, GL_FALSE, sizeof(glm::vec2), 0);
